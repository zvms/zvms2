...
import {
  structs as structsData,
  enums as enumsData,
} from "zvms-apis-data/types";
...
import {
  ...
  structsDefGenPy,
  structsDefGenTs,
} from "zvms-apis-types-gen";
import {
  authGenPy,
  authGenTs,
  catagoriesGenPy,
  catagoriesGenTs,
} from "zvms-apis-users-gen";
